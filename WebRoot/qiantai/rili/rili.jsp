...
<html>
    ...
    <body background="blue">
        <table  bgcolor="#666CC" width="185" border="0" align="center" cellspacing="1">            
            <tr height="27" bgcolor="#CCFFCC" align="center" style="font-size: 12px;">
            ...
            <tr style="font-size: 12px;">
                <% 
                  for(int i=j*7;i<(j+1)*7;i++) { 
                      ...
                      <td width="30" height="23" align="center" bgcolor="#CCFF99" style="border:1 solid"><font color="#FFFFFF"><b><%=days[i]%></b></font></td>
                <%    }else{ %>

				...
				<div
					...
					<div style="border: 1px solid #A9A9A9">
						...
						<div id="publishShow" style="margin: 2px;">
								...
								<form action="<%=path %>/addShow.action" method="post" enctype="multipart/form-data">
									标题：<input type="text"  style="width: 50%;margin-top: 20px;" name="showTitle" />
									<br/>
									文件：<input type="file"  style="width: 50%;margin-top: 20px;margin-bottom: 20px;" name="file"/>
									<br/>

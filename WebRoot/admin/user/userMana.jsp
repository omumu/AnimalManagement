...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  function chkvalue(){
	  ...
	  if(document.getElementById("input-4").value==""){
	   ...
	   window.location.href="<%=path %>/userserch.action?userRealname="+name; 
	...
	<span class="input input--hoshi">
					...
					<label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
						<span class="input__label-content input__label-content--hoshi" style="font-size:15px">用户姓名搜索</span>
					</label>
				</span><br>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
		        ...
		        <s:iterator value="#request.userserch" id="user" status="ss">
